...
The goal of your project is to predict the manner in which they did the exercise. This is the "classes" variable in the training set. You may use any of the other variables to predict with.
